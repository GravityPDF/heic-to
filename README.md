...
Currently, heic-to is using [libheif 1.23.3](https://github.com/strukturag/libheif/releases/tag/v1.23.3) and [libde265 1.1.2](https://github.com/strukturag/libde265/releases/tag/v1.1.2) under the hood.
